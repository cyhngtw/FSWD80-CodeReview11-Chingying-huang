...
// !!!  "uploads" is a folder inside of the main folder
      ...
      if (!file_exists($filename)) {
        ...
        if ((move_uploaded_file($_FILES['file']['tmp_name'],$filename))) {
           $sql = "INSERT INTO location (image, name, type, city, zip, address, tel, web, style, price, locdate ) VALUES ('$newnameoftheimage','$name', '$type', '$city','$zip','$add','$tel','$web','$style','$price','$locdate')";
